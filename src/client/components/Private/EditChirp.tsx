...
const Edit = (props: EditProps) => {
    ...
    const deleteChirp = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                return await apiService(`/api/chirps/${id}`, 'DELETE')
                    .then(() => {
                        Swal.fire({
                            title: 'Deleted!',
    ...
    const editChirp = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                return await apiService(`/api/chirps/${id}`, 'PUT', { content })

                    .then(() => {
                        Swal.fire({
                            title: 'Edit Saved!',
                            text: `Your Chirp #${chirp?.id} has been edited.`,
                            imageUrl: 'data:image/jpeg;base64,',
                            icon: 'success',
                        })
                    }
